                    ...
                    <div className="right-content">
                        <div className="up-content">
                            ...
                            <span className="span2">
                                don't have an account? <a style={{ color: "#356325" }}>Sign up</a>
                            </span>
                            ...
                            <div className="password">
                                ...
                                <div className="wrapper">
                                    <div>
                                        {isShowPassword == true ?
                                            <div>
                                                <input type="text" placeholder="*********" onChange={(event) => this.handlePassword(event)} />
                                            ...
                                            :
                                            <div>
                                                <input type="password" placeholder="*********" onChange={(event) => this.handlePassword(event)} />
                        ...
                        <div className="bottom-content">
                            ...
                            <button onClick={() => this.showValue()}>Sign in</button>
